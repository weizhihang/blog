...
//            $str .= "<td class='text-left'>\$spacer<a href='{:url(“../$module/$action”，$files“=”$id)}' class='green' title='查看内容'>\$catname </a>&nbsp;</td>";
            $str .= "<td class='text-left'>\$spacer<a href='../\$module/\$action/\$files/\$id.html' class='green' title='查看内容'>\$catname </a>&nbsp;</td>";
//            $str .= "<td class='text-left'>\$spacer<a href='";
//            $str .="\'{:url(\"/admin/".$module."/".$action."?".$files."=".$id.")}\'";
//            $str .="class='green' title='查看内容'>".$catname." </a>&nbsp;</td>";
